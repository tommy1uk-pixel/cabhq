            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <p className="text-sm text-white/45">
                  We’ll use this information to understand your business and
                  tailor the demo to your operation.
                </p>
              </form>
            ) : (
              <div className="flex min-h-[520px] flex-col items-center justify-center rounded-2xl border border-emerald-400/20 bg-emerald-400/5 p-8 text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-emerald-400/10 text-3xl text-emerald-300">
                  ✓
                </div>
